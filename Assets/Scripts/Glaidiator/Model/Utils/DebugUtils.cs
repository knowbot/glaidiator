...
namespace Glaidiator.Model.Utils
{
    public static class DebugUtils
    {
        ...
        {
            Debug.DrawLine(min, new Vector3(min.x, max.z), color, duration);
            Debug.DrawLine(new Vector3(min.x, max.y), max, color, duration);
            Debug.DrawLine(max, new Vector3(max.x, min.z), color, duration);
            Debug.DrawLine(min, new Vector3(max.x, min.z), color, duration);
        }
